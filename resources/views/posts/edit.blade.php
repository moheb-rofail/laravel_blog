    ...
    <div class="overflow-x-auto">
            <form method="post" action="/posts/{{$post->id}}">
                ...
                <label for="title">
                    ...
                    <input type="text" name="title" value="{{$post['title']}}" id="title" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                </label>

                <label for="body">
                    <span class="text-sm font-medium text-gray-700"> Body </span>
                    <textarea id="body" name="body" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm">{{$post->body}}</textarea>
                </label>
